...
2. Install DotNet CLI: https://github.com/dotnet/cli. If you install it via binaries (not MSI), add path-to-dotnet-cli\bin to the environment variable PATH. Current version: b5de686ba44aed652d0115f310da2e4b6e56d0e1 1.0.0.001584
3. Clone the repo.
