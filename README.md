...
2. Install DotNet CLI: https://dotnetcli.blob.core.windows.net/dotnet/beta/Installers/Latest/dotnet-dev-win-x64.latest.exe. Latest compatible version: a729b97b356740ce0591e81f66ee95df829c34de 1.0.0-rc2-002491
3. Clone the repo.
